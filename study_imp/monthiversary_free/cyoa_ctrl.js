...
function validateID(){
  ...
  if (id1==id2){
    ...
    window.alert("Your JHID is the username of your JHU email. Both fields must match in order to continue!");
  }
}
...
function download_data (){
  ...
  const sFileName = 'cyoa_'+story_name +'-'+version+'_end'+ending+'_'+prolific_PID+'.sona';    // The file to save the data.
